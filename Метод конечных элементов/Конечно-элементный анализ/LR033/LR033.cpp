...
// LR033.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLR033App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CLR033App::OnAppAbout)
...
CLR033App::CLR033App() noexcept
{
	...
	SetAppID(_T("LR033.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CLR033App

CLR033App theApp;


// Инициализация CLR033App

BOOL CLR033App::InitInstance()
{
...
// Обработчики сообщений CLR033App
