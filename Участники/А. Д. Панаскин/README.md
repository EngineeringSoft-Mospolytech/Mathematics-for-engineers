...
|Исправление методичек и материалов прошлых семестров  | 4|
|Актуализация Гитхаба и Доски Миро  |10 |
|Работа с битрикс  | 2|
|Изучение методов расчёта погрешностей    | 12|
|Реализация методов|8 |
|Реализация графического интерфейса |10 |
|Написание методического пособия |6 |
|Создание командного постера |5|
|Написание итоговой отчётности  | 4|
